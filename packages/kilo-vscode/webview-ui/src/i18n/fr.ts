export const dict = {
  ...
  "speechToText.tooltip.unsupported": "La saisie vocale n'est pas prise en charge dans cette webview",
  "speechToText.error.title": "La saisie vocale a échoué",
  "speechToText.error.unsupported": "La saisie vocale n'est pas prise en charge dans cette webview.",
