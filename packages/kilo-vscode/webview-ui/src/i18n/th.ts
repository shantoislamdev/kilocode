export const dict = {
  ...
  "speechToText.tooltip.unsupported": "ไม่รองรับการป้อนข้อมูลด้วยเสียงใน webview นี้",
  "speechToText.error.title": "การป้อนข้อมูลด้วยเสียงล้มเหลว",
  "speechToText.error.unsupported": "ไม่รองรับการป้อนข้อมูลด้วยเสียงใน webview นี้",
