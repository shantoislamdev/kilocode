...
export const dict = {
  ...
  "speechToText.tooltip.unsupported": "Spracheingabe wird in dieser Webview nicht unterstützt",
  "speechToText.error.title": "Spracheingabe fehlgeschlagen",
  "speechToText.error.unsupported": "Spracheingabe wird in dieser Webview nicht unterstützt.",
