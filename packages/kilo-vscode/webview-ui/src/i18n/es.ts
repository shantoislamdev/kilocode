export const dict = {
  ...
  "speechToText.tooltip.unsupported": "La entrada de voz no es compatible en esta webview",
  "speechToText.error.title": "Falló la entrada de voz",
  "speechToText.error.unsupported": "La entrada de voz no es compatible en esta webview.",
