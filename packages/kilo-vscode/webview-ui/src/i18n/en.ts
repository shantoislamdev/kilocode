export const dict = {
  ...
  "speechToText.tooltip.unsupported": "Speech input is not supported in this webview",
  "speechToText.error.title": "Speech input failed",
  "speechToText.error.unsupported": "Speech input is not supported in this webview.",
